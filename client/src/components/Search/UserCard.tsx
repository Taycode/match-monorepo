  ...
  return (
    <div className="flex items-center justify-between w-full bg-[#F1F0FA] rounded-xl px-4 py-2">
      <div className="flex gap-3 items-center max-w-[150px] md:max-w-[200px] lg:max-w-sm w-full">
        ...
        <div>
          <h2 className="text-[#1A1B22] font-medium text-sm md:text-base lg:text-lg max-w-[150px] md:max-w-[200px] lg:max-w-sm overflow-hidden truncate">
            {talent.name}
          </h2>
          <h6 className="text-[#5E5E62] text-xs md:text-sm font-medium mt-1 font-satoshi">
            {talent.expertise}
          </h6>
          <p className="text-[#5E5E62] text-xs md:text-sm font-medium mt-1 font-satoshi">
      ...
      <div className="flex flex-col gap-2">
        ...
        <h4 className="text-secondary font-semibold text-xs">Match Score</h4>
      </div>
      ...
      >
        <span
          className={`text-primary font-medium text-sm font-satoshi hidden md:block ${
